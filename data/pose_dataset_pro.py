...
class PoseDataset(data.Dataset):
    def __init__(self, source, mode, data_dir, n_pts, img_size, points_process ='', vis = False):
        """
        Args:
        ...
        self.points_process = points_process
        if points_process != '':
            assert 'fru' in points_process or 'NP' in points_process\
                or 'SC' in points_process            
